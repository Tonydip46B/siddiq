...
## Adding Vercel Web Analytics to Your Project

For supported frameworks (Next.js, Next.js App Router, SvelteKit, Remix, Create React App, Nuxt, Vue, Astro, and others):
